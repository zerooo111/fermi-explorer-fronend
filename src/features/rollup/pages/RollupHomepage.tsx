...
import { useBlocks, useLatestBlock, useStatus } from "@/features/rollup/hooks/useApi";
import {
	formatRelativeTime,
	formatTimestamp,
	truncateAddress,
	...
	return (
		<div className="space-y-6 sm:space-y-8 container mx-auto max-w-screen-xl px-0 sm:px-6">
			...
			<div className="flex flex-col gap-4">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-px border border-zinc-700">
						...
						<div className="flex items-center justify-between mb-2">
							...
							<div className="flex items-center gap-2">
								<div
									className={cn(
										"h-2 w-2 border",
										isLive ? "bg-green-500 border-green-400" : "bg-zinc-500 border-zinc-400"
									)}
								/>
